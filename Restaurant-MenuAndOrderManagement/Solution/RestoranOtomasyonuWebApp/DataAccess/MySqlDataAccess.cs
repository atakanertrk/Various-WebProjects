    ...
    public class MySqlDataAccess : IDataAccess
    {
        ...
        public void TamamlanmislaraEkle(string urunAdi, decimal urunFiyati, decimal adet,int masaNo)
        {
            ...
            using (IDbConnection connection = new MySqlConnection(connstr))
            {
                ...
                p.Add("@tarih", date);
                p.Add("@masaNo", masaNo);
                // SELECT * FROM tamamlanmissiparisler WHERE tarih="2020/10/10"
                // INSERT INTO TamamlanmisSiparisler (urunAdi,urunFiyati,adet,tarih) VALUES ('test',12.50,5,'2020/12/05')
        ...
        public int YeniGurupEkle(string yeniGurupAdi)
        {
            using (IDbConnection connection = new MySqlConnection(connstr))
            {
                ...
                string sql = "INSERT INTO UrunGuruplari (gurupAdi) VALUES (@yeniGurupAdi); SELECT LAST_INSERT_ID();";
        ...
        public int UrunEkle(UrunModel urunModel)
        {
            using (IDbConnection connection = new MySqlConnection(connstr))
            {
                ...
                string sql = "INSERT INTO Urunler (gurupId,urunAdi,urunAciklamasi,urunFiyati,stokVarYok) VALUES (@gurupId,@urunAdi,@urunAciklamasi,@urunFiyati,@stokVarYok); SELECT LAST_INSERT_ID();";
